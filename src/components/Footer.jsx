        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5 ">
              <div className="relative bg-white p-1 rounded-xl shadow-glow">
                <img src={logo} alt="Laksh Automations logo" title="Laksh Automations logo" width="60" height="40" loading="lazy" decoding="async" className="w-15 h-12 rounded-xl shadow-glow group-hover:scale-110 transition-transform duration-300" />
              </div>
              <div>
          ...
          <div>
            <h3 className="text-white font-display font-semibold text-sm mb-5 uppercase tracking-wider">
              ...
              Need Immediate Support? Contact us for product enquiries and technical assistance.
            </p>
            <a
